...
This module implements the HttpMax API.

:copyright: (c) 2023 by Shayan Heidari.
...
async def request(
        method: Union[str, bytes], url: Union[str, bytes], **kwargs
) -> Response:
...
async def get(url: Union[str, bytes], params=None, **kwargs):
